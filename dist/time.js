...
export function getDailyBlockTimestamps(date) {
    const day = baseDayCET(date);
    const entries = Object.keys(BLOCKS).map((blockKey) => {
        ...
        const end = endParts.hour < startParts.hour ||
